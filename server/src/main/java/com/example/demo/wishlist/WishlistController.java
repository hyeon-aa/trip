...
public class WishlistController {
  ...
  @PostMapping
  public ResponseEntity<WishlistResponse> add(@RequestBody CreateWishlistRequest request) {
    return ResponseEntity.ok(wishlistService.add(request));
  }
  ...
  public ResponseEntity<WishlistResponse> updateMemo(
      @PathVariable Long id, @RequestBody UpdateWishlistMemoRequest request) {
    return ResponseEntity.ok(wishlistService.updateMemo(id, request));
  }
}
