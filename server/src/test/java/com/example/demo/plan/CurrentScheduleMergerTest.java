...
class CurrentScheduleMergerTest {
    ...
    void 이번_턴_후보에_이미_있는_id는_DB_조회_없이_그대로_재사용한다() {
        ...
        ScheduleDto schedule = new ScheduleDto(List.of(
            new ScheduleDto.DayDto(1, List.of(placeDto("p101", "성산일출봉")))
        ));
    ...
    void 이번_턴_후보에_없는_p_id는_findById로_바로_가져온다() {
        ...
        ScheduleDto schedule = new ScheduleDto(List.of(
            new ScheduleDto.DayDto(2, List.of(placeDto("p102", "우도")))
        ));
    ...
    void 이번_턴_후보에_없는_w_id는_wishlistRepository_findById로_가져온다() {
        ...
        ScheduleDto schedule = new ScheduleDto(List.of(
            new ScheduleDto.DayDto(1, List.of(placeDto("w7", "오늘의집카페")))
        ));
    ...
    void DB에서도_못_찾으면_삭제된_장소_등_조용히_스킵한다() {
        ...
        ScheduleDto schedule = new ScheduleDto(List.of(
            new ScheduleDto.DayDto(1, List.of(placeDto("p999", "삭제된 장소")))
        ));
    ...
    void id가_null이거나_형식이_이상하면_조용히_스킵한다() {
        ...
        ScheduleDto schedule = new ScheduleDto(List.of(
            new ScheduleDto.DayDto(1, List.of(
    ...
    void recommendedTime이_있으면_섹션에_시간을_같이_표기한다() {
        ...
        ScheduleDto schedule = new ScheduleDto(List.of(
            new ScheduleDto.DayDto(2, List.of(
