...
class PlanChatResponseSchemaBuilderTest {
  ...
  void 넘겨준_id들만_place_id_enum에_포함된다() {
    ...
    JsonNode idEnum =
        schema.at(
            "/properties/schedule/properties/days/items/properties/places/items/properties/id/enum");
  ...
  void type은_question과_schedule_두_값만_허용한다() {
    ...
    assertThat(typeEnum)
        ...
        .containsExactlyInAnyOrder("question", "schedule");
  }
  ...
  void 최상위_필수는_type과_message뿐이라_question과_schedule_응답_둘_다_허용한다() {
    ...
    assertThat(required)
        .extracting(JsonNode::asString)
        .containsExactlyInAnyOrder("type", "message");
  }
}
